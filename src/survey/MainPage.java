...
public class MainPage {
    ...
    public void mainPageView(int id) throws SQLException {
        ...
        question.setBounds(50, 125, 450, 30);
        ...
        option1.setBounds(50, 190, 200, 30);
        ...
        option2.setBounds(50, 255, 200, 30);
        ...
        submit.addActionListener(new ActionListener(){
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                String op4 = option4Field.getText();
                if(!(qn.equals("") && op1.equals("") && op2.equals("") && op3.equals("") && op4.equals(""))) {
                    JOptionPane.showMessageDialog(frame, "Last details not added. If not required, Please clear the fields!", "Warning Message", JOptionPane.WARNING_MESSAGE);
                }
                else {
                    if(i == 0) {
                        JOptionPane.showMessageDialog(frame, "No Questions Added", "Warrning Message", JOptionPane.WARNING_MESSAGE);   
                    }
                    else {
                        try {
                            ...
                            JOptionPane.showMessageDialog(frame, "Survey Added. Survey Code: " + code, "Condgradulations", JOptionPane.PLAIN_MESSAGE);
        ...
        tabel.setBackground(Color.decode("#f9d6c4"));
        ...
        quesView.setBounds(100,70,350,225);
        ...
        JButton viewSurvey = new JButton("Add survey");
        ...
        JButton logout = new JButton("Add survey");
    ...
    public void tblupdt(String str) {
        try {
            ...
            ResultSet res = new man.surveys(id, str);
